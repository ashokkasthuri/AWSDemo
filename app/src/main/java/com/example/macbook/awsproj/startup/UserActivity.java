...
import com.example.macbook.awsproj.events.ListEventsActivity;
...
public class UserActivity extends AppCompatActivity {
    ...
    // Add a new event
    private void eventAttribute() {
        Intent eventattribute = new Intent(this,ListEventsActivity.class);
        startActivityForResult(eventattribute, 22);
    }
    // Add a new attribute
