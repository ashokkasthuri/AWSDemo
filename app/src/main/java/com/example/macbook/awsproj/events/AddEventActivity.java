...
public class AddEventActivity extends AppCompatActivity {
    ...
    private void save() {
        ...
        CreateEventMutation addEventMutation = CreateEventMutation.builder()
                .name(nameString)
                .when(timeString)
                .where(upsString)
        ...
        List<ListEventsQuery.Item1> items = new ArrayList<>();
...
//        Event event = new Event("Event", tempID, descriptionString, nameString, timeString, upsString, new Event.Comments("Comment", items));
        addEventOffline(new ListEventsQuery.Item("Event", tempID, nameString, upsString, timeString, descriptionString, new ListEventsQuery.Comments("Comments", items, "NextToken")));
    ...
    private GraphQLCall.Callback<CreateEventMutation.Data> addEventsCallback = new GraphQLCall.Callback<CreateEventMutation.Data>() {
        @Override
